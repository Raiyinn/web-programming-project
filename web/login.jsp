<%-- 
    Document   : login
    Created on : Nov 23, 2021, 6:49:53 PM
    Author     : Tarik
--%>
    ...
    <body>
        <div class="registration-form">
            <form action="Login" method="POST">
                ...
                <hr>
                <div class="form-group">
                    <a href="register.jsp" class="btn btn-block create-account">Register</a>
                </div>
                <div class="form-group">
                    <form method="GET" action="GetProducts">
                    <a href="Guest" class="btn btn-block create-account">Enter as guest</a>
                </form>
